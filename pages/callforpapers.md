...
{{< image src="{{site.baseurl}}/assets/images/e3s.png" caption="" alt="EDP Sciences" height="" width="" position="center" command="fill" option="q100" class="img-fluid" title="image title"  webp="false" >}}.
